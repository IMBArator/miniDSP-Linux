...
with mkdocs_gen_files.open("api/index.md", "w") as fd:
    fd.write(
        "# API Reference\n\n"
        "Auto-generated reference for the runtime control library "
        "([`minidsp`](minidsp/index.md)) and the protocol-analysis "
        "toolchain ([`dspanalyze`](dspanalyze/index.md)).\n"
    )
...
with mkdocs_gen_files.open("api/SUMMARY.md", "w") as nav_file:
    ...
    # "API Reference" landing page, instead of absorbing minidsp/index.md.
